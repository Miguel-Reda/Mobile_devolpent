...
public class RouteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        routeString.append(getTime(numberOfStations));
    ...
    public StringBuilder getRouteString(String direction) {
    ...
    public StringBuilder getTime(int numberOfStations) {
        StringBuilder routeString = new StringBuilder();
    ...
    public byte getTicketPrice(int numberOfStations){
        byte ticketPrice;
